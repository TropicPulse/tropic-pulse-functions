...
// ============================================================================
//
//  BODY THEME — ORGAN ROLE (v7.7):
//  --------------------------------
//  PulseOSMemory is the **LIVER** of PulseOS.
//  It is the **METABOLIC ARCHIVE + RESTORE ORGAN** of the OS — the place
//  where long‑term state, drift signatures, and restore points are stored
//  in a deterministic, drift‑proof way.
//
//  WHAT THIS ORGAN DOES (v7.7):
//  ----------------------------
//    • Captures OS + subsystem snapshots (long‑term state capture)
//    • Records drift signatures (immune memory)
//    • Creates restore points (OS time machine)
//    • Generates restore plans (read‑only restore intent)
//    • Trims old snapshots + restore points (metabolic hygiene)
//
//  WHAT THIS ORGAN IS NOT:
//  ------------------------
//    • NOT a brain (no IQ, no reasoning)
//    • NOT a healer (no decisions, no orchestration)
//    • NOT a router (no routing logic)
//    • NOT a compute engine (no heavy processing)
//    • NOT a marketplace client
//
...
//    • Same inputs → same stored state behavior
//
//  IDENTITY (v7.7):
//  ----------------
//    • organ: PulseOSMemory
...
log(
  "%c🟦 PulseOSMemory v7.7 online — LIVER / OS archival engine active.",
