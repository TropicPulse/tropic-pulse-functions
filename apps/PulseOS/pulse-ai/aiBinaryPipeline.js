/**
 * aiBinaryPipeline.js — Pulse OS v11‑EVO Organ
 * ---------------------------------------------------------
 * CANONICAL ROLE:
 *   This organ is the **Binary Compute Pipeline** of Pulse OS.
 *
 *   It defines:
 *     • binary compute flow
 ...
 *     • observer taps
 *     • reflex hooks
 *     • binary flow arteries (throughput, pressure, cost, budget)
 *
...
class AIBinaryPipeline {
  constructor(config = {}) {
    this.id = config.id || 'ai-binary-pipeline';
